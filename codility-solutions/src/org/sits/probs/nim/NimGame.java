package org.sits.probs.nim;

import java.util.Random;
import java.util.Scanner;

/**
 * Implements a game of nim, person vs. computer. The game starts with a number
 * of elements chosen by the person. The computer takes 1 or 2 elements. Then
 * the person takes 1 or 2 elements. The game continues until there are no
 * elements left. The play who takes the last turn wins
 */
